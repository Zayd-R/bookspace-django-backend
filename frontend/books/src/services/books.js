...
const getUserBooks = ()=>{
    axios.get(baseUrl, logService.config())
...
const addNewBook = (newBook)=>{
    axios.post(baseUrl, newBook ,logService.config())
    .then(response=>console.log(response.data))
    .catch(error=>console.log(error))
}
...
const updateState = (book_id,bookToUpdate)=>{
    axios.put(`${baseUrl}/${book_id}`,bookToUpdate, logService.config())
    .then(response=>console.log(response.data))
    .catch(error=>console.log(error))
}
...
const deleteBook = (book_id)=>{
    axios.delete(`${baseUrl}/${book_id}`, logService.config())
    .then(response=>console.log(response.data))
    .catch(error=>console.log(error))
}
