...
const Book = ()=>{
    ...
    useEffect( ()=>{
      if(match){
        axios.get(`https://www.googleapis.com/books/v1/volumes/${match.params.id}`).then(result=>{
		    ...
		    <div className="row">
			    <div className="col-12 col-md-7 pt-5 mb-5 align-self-center">
				    <div className="promo pe-md-3 pe-lg-5">
                        ...
                        <div className="subheadline mb-4">
                            ...
                            <br/>
                            <div>
                            Publisher: {book.volumeInfo.publisher.slice(1, -1)}
                            </div>
                            <br/>
                            <div>
					    ...
					    <div className="subheadline mb-4">
                            ...
                            <div dangerouslySetInnerHTML={{ __html: book.volumeInfo.description ?  book.volumeInfo.description :'No description available' }} />

					    </div>
					    
					    <div className="cta-holder row gx-md-3 gy-3 gy-md-0">
						    <div className="col-12 col-md-auto">
						        <a className="btn btn-primary w-100" href={book.volumeInfo.previewLink}>Read a sample</a>
						    </div>
						    <div className="col-12 col-md-auto">
						        <a className="btn btn-secondary scrollto w-100" href={book.volumeInfo.infoLink}>Check on GooglePLay</a>
						    </div>
					    </div>
                ...
                <br/>
				    <div className="book-cover-holder">
					    <img style={{width: '70%'}}  src={book.volumeInfo.imageLinks.large ? book.volumeInfo.imageLinks.large:book.volumeInfo.imageLinks.thumbnail } alt="book cover" />
